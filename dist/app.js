...
var ProjectState = (function (_super) {
    ...
    ProjectState.prototype.updateListners = function () {
...
var ProjectInput = (function (_super) {
    ...
    ProjectInput.prototype.gatherUserInput = function () {
        ...
        var descriptionVlidatable = {
            value: enteredDescription,
            required: true,
            minLength: 5,
        };
        var peopleVlidatable = {
            value: +enteredPeople,
            required: true,
            minLength: 1,
        };
        if (!validate(titleVlidatable) ||
            !validate(descriptionVlidatable) ||
            !validate(peopleVlidatable)) {
